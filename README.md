...
- Capability reuse is now guarded proactively too: when multiple running service shells claim the same capability, `/ps services`, `background_shell_list`, and orchestration guidance surface that conflict before a later `@capability` reference fails as ambiguous.
