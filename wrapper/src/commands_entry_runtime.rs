...
pub(crate) const RUNTIME_COMMAND_ENTRIES: &[BuiltinCommandEntry] = &[
    ...
    BuiltinCommandEntry {
        name: "ps",
        help_syntax: "ps [blockers|agents|shells|services|terminals|poll <jobId|n>|terminate <jobId|n>|alias <jobId|n> <name>|unalias <name>|clean [blockers|shells|services|terminals]]",
