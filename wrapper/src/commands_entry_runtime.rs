...
pub(crate) const RUNTIME_COMMAND_ENTRIES: &[BuiltinCommandEntry] = &[
    ...
    BuiltinCommandEntry {
        name: "ps",
        help_syntax: "ps [blockers|agents|shells|services|terminals|attach <jobId|alias|n>|wait <jobId|alias|n> [timeoutMs]|run <jobId|alias|n> <recipe> [json-args]|poll <jobId|alias|n>|send <jobId|alias|n> <text>|terminate <jobId|alias|n>|alias <jobId|n> <name>|unalias <name>|clean [blockers|shells|services|terminals]]",
