...
| `client_event` publish | strong proof | [wrapper/tests/connector_prototype_smoke/fixture/events/client_events.rs](../wrapper/tests/connector_prototype_smoke/fixture/events/client_events.rs), [codexw-broker-client-fixture.md](codexw-broker-client-fixture.md) | No major prototype gap on the currently claimed client-event route surface. |
