...
- `wrapper/src/client_dynamic_tools_tests_orchestration/core.rs`
  Orchestration dynamic-tool spec, status, filter, and dependency-view regression tests.
...
- `wrapper/src/client_dynamic_tools/specs.rs`
  Advertised client dynamic-tool schema bundle.
...
- `wrapper/src/client_dynamic_tools_tests_shells/recipes/invoke.rs`
  Background-shell recipe invocation dynamic-tool regressions across HTTP/TCP/Redis and parameterized recipes.
...
- `wrapper/src/background_shells/services/render/views.rs`
  Reusable-service `:ps` and dynamic-tool rendering helpers.
...
- `wrapper/src/background_shells/recipes/transports.rs`
  Typed service-recipe transport execution helpers for HTTP, TCP, and Redis actions.
...
- `wrapper/src/background_shells/tests/services/recipes/invoke.rs`
  Reusable-service recipe invocation, readiness-wait, and transport regression tests.
...
- `wrapper/src/dispatch_command_session_ps/parse.rs`
  `:ps` selector parsing, JSON/operator argument decoding, and cleanup/service/dependency filter helpers.
...
- `wrapper/src/dispatch_command_session_ps/control.rs`
  Mutating and job-control `:ps` flows such as send, poll, attach, wait, run, alias, terminate, provide, depend, contract, and relabel.
