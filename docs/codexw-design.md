...
- `wrapper/src/background_shells/execution/runtime/process.rs`
  Background-shell cwd/intent/alias/capability parsing, process startup, output-reader, and termination helpers.
