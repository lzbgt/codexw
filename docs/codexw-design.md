...
- `wrapper/src/background_shells/services/updates/mutations.rs`
  Live reusable-service contract/capability/dependency mutation and capability-scoped termination helpers.
