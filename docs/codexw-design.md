...
- `wrapper/src/requests/bootstrap_catalog.rs`
  Compatibility facade for split catalog/config/model/discovery request builders.
...
- `wrapper/src/requests/thread_activity.rs`
  Compatibility facade for the split thread realtime/review request builders.
...
- `wrapper/src/requests/turn_requests.rs`
  Compatibility facade for split turn request builders.
...
- `wrapper/src/response_bootstrap_catalog.rs`
  Compatibility facade for split bootstrap state/view response handlers.
...
- `wrapper/src/response_error.rs`
  Compatibility facade for split session/runtime response error handling.
